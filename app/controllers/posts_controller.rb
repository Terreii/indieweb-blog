class PostsController < ApplicationController
  ...
  def create
    post = Post.new post_params[:entryable_attributes]
    @entry = Entry.new(post_params.except(:entryable_attributes).merge entryable: post)
  ...
  private
    ...
    def post_params
      params.require(:entry).permit(Entry.permitted_attributes_with :id, :slug, :summary, :thumbnail, :body)
    end
